...
### 1. Ingest
- Use the inline args text as the spec. Never read the spec from a file.
...
- **Fit the real project.** Reference actual files, conventions, tooling, and architecture found in the repo and `CLAUDE.md` — whatever the stack. Don't impose patterns the repo doesn't use.
